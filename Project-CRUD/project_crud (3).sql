...
(1, NULL, 'Dashboard', '?page=dashboard', 'bx bx-grid-alt', 1, 1),
(2, NULL, 'User Management', NULL, 'bx bx-group', 2, 1),
(3, 2, 'Users', '?page=user', 'bx bx-user', 1, 1),
(4, 2, 'Roles', '?page=role', 'bx bx-shield', 2, 1),
(5, NULL, 'Menus', '?page=menu', 'bx bx-list-ul', 3, 1),
(6, NULL, 'Categories', '?page=category', 'bx bx-purchase-tag', 4, 1),
(7, NULL, 'Products', '?page=product', 'bx bx-package', 5, 1);
...
INSERT INTO `orders` (`id`, `order_number`, `customer_name`, `payment_method`, `subtotal`, `tax`, `discount`, `total_bill`, `cash_received`, `cash_change`, `payment_status`, `created_at`) VALUES
(0, 'ORD-20260602-2585', 'j', 0, 10000.00, 1000.00, 0.00, 11000.00, 0.00, 0.00, 'SUCCESS', '2026-06-02 14:11:10');
...
(0, 0, 1, 'Ayam', 10000.00, 1, 10000.00);
...
(1, 1, 'Ayam', 'https://tse2.mm.bing.net/th/id/OIP.ij_3f_mcNWt054cKb_0C6wHaHa?pid=Api&P=0&h=180', 2, 10000, 'pcs', '', 1),
(2, 1, 'Granita', 'assets/uploads/products/1780407529_image.jpg', 4, 2000, 'pcs', '', 1);
...
(304, 'User 300', 'user300@mail.com', '123456', 2);
