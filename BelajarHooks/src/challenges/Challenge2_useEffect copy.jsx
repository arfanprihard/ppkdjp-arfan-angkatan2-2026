  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <div style={{ fontWeight: 700, fontSize: "14px", color: "#f0f0f8" }}>
            {user.name}
          </div>
    ...
    fetch("https://jsonplaceholder.typicode.com/users")
      ...
      .catch((err) => {
        if (!cancelled) {
          setError(
            err.message ||
              "Gagal mengambil data. Periksa koneksi internet kamu.",
          );
          setLoading(false);
        }
      });
  ...
  return (
    ...
    >
      ...
      >
        <div>
          ...
          <p style={{ color: "#a0a0c0", fontSize: "12px", margin: 0 }}>
            ...
            >
              src/challenges/Challenge2_useEffect.jsx
            </code>
          </p>
        </div>
        <div style={{ textAlign: "right" }}>
          ...
          <div style={{ fontSize: "11px", color: "#555", marginTop: "4px" }}>
            ...
            <span
              style={{
                color: countdown <= 5 ? "#E17055" : "#a0a0c0",
                fontWeight: 700,
              }}
            >
              {countdown}s
      ...
      >
        ...
        {loading && (
          <span style={{ color: "#00B894", animation: "pulse 1s infinite" }}>
            ⏳ Fetching…
          </span>
        )}
        {!loading && !error && fetchCount > 0 && (
          <span style={{ color: "#00B894" }}>✅ Data terbaru</span>
        )}
        ...
        >
          <button
            ...
            style={{
              padding: "6px 14px",
              borderRadius: "8px",
              background: page === 1 ? "#1a1a3a" : "#6C5CE7",
              border: "none",
              color: "#fff",
          ...
          {Array.from({ length: totalPages }, (_, i) => (
            <button
              ...
              style={{
                padding: "6px 12px",
                borderRadius: "8px",
                background: page === i + 1 ? "#6C5CE7" : "transparent",
                border: `1px solid ${page === i + 1 ? "#6C5CE7" : "#2a2a5a"}`,
                color: "#f0f0f8",
                cursor: "pointer",
                fontSize: "13px",
              }}
          ...
          <button
            ...
            style={{
              padding: "6px 14px",
              borderRadius: "8px",
              background: page === totalPages ? "#1a1a3a" : "#6C5CE7",
              border: "none",
              color: "#fff",
